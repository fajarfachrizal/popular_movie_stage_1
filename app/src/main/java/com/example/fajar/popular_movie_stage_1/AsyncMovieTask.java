...
public class AsyncMovieTask extends AsyncTask<String, Void, Movies[]> {

    private final CallbackMethod movieTaskCallback;

    AsyncMovieTask(CallbackMethod movieTaskCallback) {
